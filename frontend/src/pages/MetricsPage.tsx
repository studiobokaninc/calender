            ...
            <Paper sx={{ p: { xs: 1, sm: 1.5, md: 2 }, borderRadius: { xs: 1, sm: 2 } }}>
               ...
               <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, flexWrap: 'wrap', alignItems: { xs: 'stretch', sm: 'center' }, gap: { xs: 1.5, sm: 3 }, borderBottom: 1, borderColor: 'divider', pb: { xs: 1.5, sm: 1.5 }, mb: { xs: 1.5, sm: 1.5 }, width: '100%' }}>
                 <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, flexWrap: 'wrap', alignItems: 'stretch', gap: { xs: 1.5, sm: 2 }, flex: 1, minWidth: 0, width: { xs: '100%', sm: 'auto' } }}>
                   <FormControl size={isMobile ? "medium" : "small"} sx={{ minWidth: { xs: '100%', sm: 180 }, flex: { xs: '1 1 100%', sm: '1 1 160px' } }}>
                     <InputLabel id="date-range-label" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>期間</InputLabel>
                     <Select labelId="date-range-label" value={dateRange} label="期間" onChange={handleDateRangeChange} sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' }, '& .MuiSelect-select': { minHeight: { xs: '44px !important', sm: '36px !important' } } }}>
                       <MenuItem value="all" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>全期間</MenuItem>
                       <MenuItem value="week" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>直近1週間</MenuItem>
                       <MenuItem value="month" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>直近1ヶ月</MenuItem>
                       <MenuItem value="quarter" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>直近3ヶ月</MenuItem>
                     </Select>
                   </FormControl>
                   <Autocomplete
                     ...
                     sx={{ minWidth: { xs: '100%', sm: 220 }, flex: { xs: '1 1 100%', sm: '2 1 200px' } }}
                     renderInput={(params) => <TextField {...params} label="プロジェクト名" sx={{ '& .MuiInputBase-root': { minHeight: { xs: '44px', sm: '36px' } }, '& .MuiInputBase-input': { fontSize: { xs: '0.875rem', sm: '0.875rem' } } }} />}
                     renderOption={(props, project) => (
                       <li {...props} key={project.id} style={{ minHeight: 44, fontSize: '0.875rem' }}>
                   ...
                   />
                   <FormControl size={isMobile ? "medium" : "small"} sx={{ minWidth: { xs: '100%', sm: 180 }, flex: { xs: '1 1 100%', sm: '1 1 160px' } }}>
                     <InputLabel id="project-status-label" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>プロジェクト状態</InputLabel>
                     <Select labelId="project-status-label" value={statusFilter} label="プロジェクト状態" onChange={handleStatusFilterChange} sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' }, '& .MuiSelect-select': { minHeight: { xs: '44px !important', sm: '36px !important' } } }}>
                       <MenuItem value="all" sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>すべて</MenuItem>
                       {projectStatusOptions.map(status => (<MenuItem key={status} value={status} sx={{ fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>{status}</MenuItem>))}
                     </Select>
                   </FormControl>
                 </Box>
               </Box>
            ...
            {selectedTab === 5 && (
              <Box sx={{ p: { xs: 1, sm: 2 } }}>
                 <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1, mb: 2 }}>
                   <Typography variant="h6" sx={{ fontWeight: 600, fontSize: { xs: '1rem', sm: '1.25rem' } }}>今週の割り当て</Typography>
                           ...
                           <Table size="small" stickyHeader>
                             <TableHead>
                               <TableRow>
                                 ...
                                 <TableCell align="right" sx={{ fontWeight: 600, backgroundColor: 'background.paper', whiteSpace: 'nowrap', width: 180, fontSize: '0.875rem', px: 2 }}>ベースロード</TableCell>
