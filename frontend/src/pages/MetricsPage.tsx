                         ...
                         <Table size="small" stickyHeader>
                           <TableHead>
                             <TableRow>
                               ...
                               <TableCell align="right" sx={{ fontWeight: 600, backgroundColor: 'background.paper', whiteSpace: 'nowrap', width: 180 }}>ベースロード</TableCell>
                             ...
                             {rows.map((row) => {
                               ...
                               return (
                                 <TableRow key={row.user_id} hover sx={{ '& > td': { verticalAlign: 'middle' } }}>
                                   ...
                                   <TableCell align="right" sx={{ whiteSpace: 'nowrap', width: 180 }}>
                                     {isEditingBaseLoad ? (
